...
public class PessoaFisica extends Pessoa { // subclasse PessoaFisica
    ...
    public PessoaFisica(String nome, String endereco, String telefone, int codigo, String nomePai, String nomeMae, char sexo, String dataNascimento, String cpf, String rg, String nacionalidade, String naturalidade, double salario) {
