...
public class Trabalho01 {
    ...
    public static void main(String[] args) {
        ...
        String dataNascimentoString = "09/12/1998";
        LocalDate dataNascimento = LocalDate.parse(dataNascimentoString, DateTimeFormatter.ofPattern("dd/MM/yyyy")); // convertendo String p/ LocalDate e formatando
